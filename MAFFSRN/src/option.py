...
parser = argparse.ArgumentParser(description='MAFFSRN')
...
parser.add_argument('--dir_demo', type=str, default='/dataset',
...
parser.add_argument('--model', default='maffsrn',
                    help='model name')
...
# Log specifications
parser.add_argument('--save', type=str, default='maffsrn',
...
parser.add_argument('--calc_importance', type = bool, default = False, help='calc importance of layer?')
